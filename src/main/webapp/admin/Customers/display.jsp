...
%>
<div><a href="admin-customerServlet?service=insert">Insert Customer</a></div>
<form action="admin-customerServlet">
...
<table border="1">
  ...
  <tr>
    ...
    <td><a href="admin-customerServlet?service=update&id=<%=cus.getCustomer_id() %>">update</a></td>
    <td><a href="admin-customerServlet?service=delete&id=<%=cus.getCustomer_id() %>">delete</a></td>
  </tr>
