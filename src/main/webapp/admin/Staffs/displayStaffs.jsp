...
<body>
<div><a href="admin-staffsServlet?service=insert">Insert</a></div>
...
<form action="admin-staffsServlet">
...
<table border="1">
  ...
  <tr>
    ...
    <td><a href="admin-staffsServlet?service=update&id=<%=staffs.getStaff_id()%>">Update</a></td>
    <td><a href="admin-staffsServlet?service=delete&id=<%=staffs.getStaff_id()%>">Delete</a></td>
  </tr>
  <%}%>
</table>
<%}else{%>
