...
<body>
<div><a href="orderServlet?service=insertUpdate" name="cu">Insert</a></div>
...
<table border="1">
  ...
  <tr>
    ...
    <%}}%>
    <td><a href="orderServlet?service=insertUpdate&id=<%=order.getOrder_id()%>">Update</a></td>
    <td><a href="orderServlet?service=delete&id=<%=order.getOrder_id()%>">Delete</a></td>
  </tr>
  <%}%>
</table>
<%}else{%>
