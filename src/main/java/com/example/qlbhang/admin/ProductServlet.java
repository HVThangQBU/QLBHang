    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(service){
            case "display":
                ...
                dispath.dispath(request,response,"admin/Products/displayProduct.jsp");
                break;
            case "insert":
                dispath.dispath(request,response,"admin/Products/InsertProduct.jsp");
                break;
            case "update" :
                ...
                dispath.dispath(request,response,"admin/Products/updateProduct.jsp");
                break;
            case "delete":
                ...
                dispath.dispath(request,response,"admin/Products/deleteProduct.jsp");
                break;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (service){
            case "insert":
                ...
                response.sendRedirect("admin-productservlet");
                break;
            case "update":
