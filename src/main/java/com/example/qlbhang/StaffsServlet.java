  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    switch (service){
      case "display":
        ...
        dispath.dispath(request,response,"/Staffs/displayStaffs.jsp");
        break;
      case "insert":
        staffsDAO = new StaffsDAO();
        staffsList = staffsDAO.getStaffs();
        request.setAttribute("staffs",staffsList);
        dispath.dispath(request,response,"/Staffs/insertStaffs.jsp");
        break;
      case "update":
        ...
        dispath.dispath(request,response,"/Staffs/updateStaffs.jsp");
        break;
      case "delete":
        ...
        request.setAttribute("listStaff",listStaff);
        request.setAttribute("listStore",listStore);
        dispath.dispath(request,response,"/Staffs/deleteStaffs.jsp");
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    switch (service){
      case"insert":
        ...
        response.sendRedirect("staffsServlet");
        break;
      case "update":
